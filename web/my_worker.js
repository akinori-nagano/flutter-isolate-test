...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    List_List$from(elements, $E) {
      ...
      for (t1 = elements.$ti, t2 = new A.ListIterator(elements, elements.get$length(elements), t1._eval$1("ListIterator<ListIterable.E>")), t1 = t1._eval$1("ListIterable.E"); t2.moveNext$0();)
        B.JSArray_methods.add$1(list, $E._as(t1._as(t2.__internal$_current)));
      return list;
    },
    ...
    MyWorkerTask: function MyWorkerTask() {
    },
    main() {
      $.$get$_context().$indexSet(0, "onmessage", new A.main_onmessage());
    },
    main_onmessage: function main_onmessage() {
    },
    mapToJSObject(a) {
      var object = {};
      a.forEach$1(0, new A.mapToJSObject_closure(object));
      return object;
    },
    mapToJSObject_closure: function mapToJSObject_closure(t0) {
      this.object = t0;
    },
    isBrowserObject(o) {
  ...
  A._wrapToDart_closure.prototype = {
    call$1(o) {
      return new A.JsFunction(type$.Object._as(o));
    },
    $signature: 15
  };
  A._wrapToDart_closure0.prototype = {
    call$1(o) {
      return new A.JsArray(type$.Object._as(o), type$.JsArray_dynamic);
    },
    $signature: 16
  };
  A._wrapToDart_closure1.prototype = {
    call$1(o) {
      return new A.JsObject(type$.Object._as(o));
    },
    $signature: 17
  };
  ...
  A.MyWorkerTask.prototype = {
    multiply$2(v1, v2) {
      var n, j, i, v3;
      A.print("multiply::delay: start");
      for (n = 0.01, j = 0; j < 1000; ++j)
        for (i = 0; i < 100000; ++i, n = v3)
          v3 = B.JSNumber_methods.$mod(i * 10000 / 12.3, 999);
      A.print(n);
      A.print("multiply::delay: end");
      return B.JSInt_methods.toString$0(v1 * v2);
    }
  };
  A.main_onmessage.prototype = {
    call$1($event) {
      var t1, res, workerResult,
        mapobj = J.get$data$x($event);
      A.print("Worker: Message received from main script");
      A.print(mapobj);
      t1 = J.getInterceptor$asx(mapobj);
      res = $.$get$myWorkerTask().multiply$2(A._asInt(t1.$index(mapobj, "v1")), A._asInt(t1.$index(mapobj, "v2")));
      workerResult = A.LinkedHashMap_LinkedHashMap$_literal(["number", t1.$index(mapobj, "number"), "result", "Worker::result:send: " + res], type$.String, type$.dynamic);
      A.print("Worker::postMessage: send start.");
      self.postMessage(A.mapToJSObject(workerResult));
      A.print("Worker::postMessage: send end.");
    },
    $signature: 2
  };
  A.mapToJSObject_closure.prototype = {
    call$2(k, v) {
      this.object[type$.Object._as(k)] = v;
    },
    $signature: 18
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "js___convertToDart$closure", "_convertToDart", 19);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.FixedLengthListMixin, A.Symbol, A.MapView, A.ConstantMap, A.JSInvocationMirror, A.Closure, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A._Required, A.MapMixin, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._TimerImpl, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._Zone, A.ListMixin, A._UnmodifiableMapMixin, A.DateTime, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A._AcceptStructuredClone, A.JsObject, A.NullRejectionException, A.MyWorkerTask]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSArray, J.JSNumber, J.JSString, A.NativeTypedData, A.EventTarget, A.Blob, A.Event, A.DomException, A.ImageData, A.KeyRange]);
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.Closure0Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A._convertToJS_closure, A._convertToJS_closure0, A._wrapToDart_closure, A._wrapToDart_closure0, A._wrapToDart_closure1, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.main_onmessage]);
    _inheritMany(A.Closure2Args, [A.Primitives_functionNoSuchMethod_closure, A.initHooks_closure0, A._Future__chainForeignFuture_closure0, A.MapBase_mapToString_closure, A.NoSuchMethodError_toString_closure, A._AcceptStructuredClone_walk_closure, A.mapToJSObject_closure]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.FormElement, A.ObjectElement, A.SelectElement]);
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "myWorkerTask", "$get$myWorkerTask", () => new A.MyWorkerTask());
  })();
...
//# sourceMappingURL=my_worker.js.map
